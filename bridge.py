...
# NOTE: Add your lesson text content to the "text" field for each lesson.

# Gemini will use this exact text and include the video link.

# ────────────────────────────────────────────────

ACTIVAT_LESSONS = [
    {"title": "Какой путь проходят стартапы", "url": "https://activat.vc/startup-course/lesson/kakoi-put-prohodyat-startapy", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Что такое MVP и зачем он нужен", "url": "https://activat.vc/startup-course/lesson/chto-takoe-mvp-i-zachem-on-nuzhen", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Как найти product-market fit", "url": "https://activat.vc/startup-course/lesson/kak-naiti-product-market-fit", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Как привлечь первых клиентов", "url": "https://activat.vc/startup-course/lesson/kak-privlech-pervyh-klientov", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Юнит-экономика для стартапов", "url": "https://activat.vc/startup-course/lesson/yunit-ekonomika-dlya-startapov", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Как сделать питч-дек", "url": "https://activat.vc/startup-course/lesson/kak-sdelat-pitch-deck", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Как работают венчурные инвестиции", "url": "https://activat.vc/startup-course/lesson/kak-rabotayut-venchurnye-investicii", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Что такое cap table", "url": "https://activat.vc/startup-course/lesson/chto-takoe-cap-table", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Как проходит due diligence", "url": "https://activat.vc/startup-course/lesson/kak-prohodit-due-diligence", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Что такое term sheet", "url": "https://activat.vc/startup-course/lesson/chto-takoe-term-sheet", "text": "PROVIDE_YOUR_TEXT_HERE"},
    # Video-based lessons with transcripts
    {"title": "Что такое инвестиции: доходность, надёжность, ликвидность", "url": "https://youtu.be/RLWjDv7Hto4?si=ZdPfSdju6dfo-837", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Доходность депозитов и влияние валютного курса", "url": "https://youtu.be/RLWjDv7Hto4?si=ZdPfSdju6dfo-837", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Инвестиции в недвижимость: аренда и рост цены", "url": "https://youtu.be/RLWjDv7Hto4?si=ZdPfSdju6dfo-837", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Инвестиции в бизнес: расчёт доходности", "url": "https://youtu.be/RLWjDv7Hto4?si=ZdPfSdju6dfo-837", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Что такое стартап: признаки и отличия", "url": "https://youtu.be/_FhExnc4bgA?si=AB7PKW77eYZakprJ", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Масштабируемость и технологичность стартапов", "url": "https://youtu.be/_FhExnc4bgA?si=AB7PKW77eYZakprJ", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Пример сбалансированного инвестиционного портфеля", "url": "https://youtu.be/mLKvHpnoGcg?si=5uuUZOce2PKHRmJ9", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Венчурные инвестиции: риски и иксы", "url": "https://youtu.be/-850n7Yu8aA?si=dsoxOBYbXVsKUvb6", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Путь венчурного инвестора: от новичка к суперангелу", "url": "https://youtu.be/ZPTmrEZSunA?si=KvgfMr9TZkHIE7LP", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Где искать стартапы: каналы и нетворкинг", "url": "https://youtu.be/yVvhxXF8htI?si=9P2qIf3pcaWuW5ex", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Инвестировать в стартапы solo или в команде", "url": "https://youtu.be/suP2UjGu-H0?si=o4fV6jy9LuZNwpQq", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Что обсудить с фаундером перед инвестицией", "url": "https://youtu.be/foP0b8FUM80?si=IQOGhpfCk0tKkYBg", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Формы инвестиций: прямые, венчурные, краудфандинг", "url": "https://youtu.be/F84ihxh9wiA?si=dHXE5qQRfER0o3cL", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Способы инвестирования в бизнес", "url": "https://youtu.be/4RAFsA3Jm3E?si=hz7wh3xWgcsLLo1I", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Процесс инвестирования в стартап: от поиска до мониторинга", "url": "https://youtu.be/12JaOwIvygg?si=zsO2XtMmQ97_ZWBF", "text": "PROVIDE_YOUR_TEXT_HERE"},
    {"title": "Условия выхода инвестора из стартапа", "url": "https://youtu.be/oSCxm08Nu7U?si=Kj-DNqlXyoD20fCw", "text": "PROVIDE_YOUR_TEXT_HERE"},
]
...
# PATTERN: Activat VC → General → Activat VC → General
...
async def run_education(posted_count: int, approval_mode: bool):
    ...
    # Alternating pattern: even = Activat VC, odd = general topic
    ...
    try:
        ...
        if use_activat:
            ...
            # CRITICAL INSTRUCTION FOR GEMINI: Use the provided text content
            if lesson_text and lesson_text != "PROVIDE_YOUR_TEXT_HERE":
                prompt = (
                    "You are formatting an educational post for a Telegram channel about venture capital.\n"
                    "CRITICAL INSTRUCTIONS:\n"
                    "1. Use EXACTLY the text content provided below\n"
                    "2. Format it as a Telegram post (400-700 characters)\n"
                    "3. Start EXACTLY with: Обучение | Activat VC\n"
                    "4. Add appropriate emojis for readability\n"
                    f"5. End with: Подробнее в видео: {source_url}\n"
                    "6. Do NOT modify the main content, only format it nicely\n\n"
                    f"PROVIDED TEXT CONTENT:\n{lesson_text}\n\n"
                    f"Video link to include at the end: {source_url}\n"
                )
            else:
                # Fallback if text is not provided yet
                prompt = (
                    "You are the editor of a Telegram channel about venture capital in Central Asia.\n"
                    ...
                    f"- End with: Подробнее в видео: {source_url}\n"
                    "- No hashtags\n"
                )
